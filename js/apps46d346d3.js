...
const sttaddr = "0x4d50471035d65810cdb9b34550d46b31bf398cb8";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
    fresh = "0x4d50471035d65810cdb9b34550d46b31bf398cb8";
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  document.getElementById('refaddress').value = 'https://ocen.network/get.php?ref=' + document.getElementById('refaddress').value;
}
}
}
